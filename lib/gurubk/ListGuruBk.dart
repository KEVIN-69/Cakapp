...
import 'package:projectcakapp/gurubk/UpdateGuruBk.dart';
...
class _ListGuruBkPageState extends State<ListGuruBkPage> {
  ...
  FirebaseFirestore.instance.collection('gurubk').snapshots();

  CollectionReference gurubk =
  FirebaseFirestore.instance.collection('gurubk');
                          ...
                          IconButton(
                            onPressed: () => {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => UpdateGuruBkPage(id: storedocs[i]['id']),
                                ),
                              )
                            },
                            icon: Icon(
